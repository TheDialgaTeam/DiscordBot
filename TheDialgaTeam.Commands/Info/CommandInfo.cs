...
using TheDialgaTeam.Commands.Extensions;
using TheDialgaTeam.Commands.Results;

namespace TheDialgaTeam.Commands.Info
{
    /// <summary>
    ...
    public class CommandInfo
    {
        ...
        private readonly Func<string, object[], IServiceProvider, CommandInfo, Task> _action;
        ...
        public async Task<ParseResult> ParseAsync(string commandString, int startIndex, SearchResult searchResult, PreconditionResult preconditionResult = null, IServiceProvider services = null)
        {
            services = services ?? EmptyServiceProvider.Instance;
            ...
            return await CommandParser.ParseArgsAsync(this, commandString, _commandService._ignoreExtraArgs, services, input, 0, _commandService._quotationMarkAliasMap).ConfigureAwait(false);
        }
        ...
        public Task<IResult> ExecuteAsync(string commandString, ParseResult parseResult, IServiceProvider services)
        {
            ...
            return ExecuteAsync(commandString, argList, paramList, services);
        }
        ...
        internal string GetLogText(string commandString)
        {
            return $"\"{Name}\"";
        }
    }
