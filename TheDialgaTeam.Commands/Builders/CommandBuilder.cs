...
namespace TheDialgaTeam.Commands.Builders
{
    public class CommandBuilder
    {
        ...
        internal Func<string, object[], IServiceProvider, CommandInfo, Task> Callback { get; set; }
        ...
        //User-defined
        internal CommandBuilder(ModuleBuilder module, string primaryAlias, Func<string, object[], IServiceProvider, CommandInfo, Task> callback)
            : this(module)
        {
            Callback = callback ?? throw new ArgumentNullException(nameof(callback));
            PrimaryAlias = primaryAlias ?? throw new ArgumentNullException(nameof(primaryAlias));
