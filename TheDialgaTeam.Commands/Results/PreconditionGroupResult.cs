...
namespace TheDialgaTeam.Commands.Results
{
    [DebuggerDisplay(@"{DebuggerDisplay,nq}")]
    public class PreconditionGroupResult : PreconditionResult
    {
        public ICollection<PreconditionResult> PreconditionResults { get; }
        ...
        {
            PreconditionResults = (preconditions ?? new List<PreconditionResult>(0));
        }
